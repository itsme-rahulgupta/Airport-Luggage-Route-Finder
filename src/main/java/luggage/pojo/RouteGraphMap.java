...
public class RouteGraphMap {
    // mapping of vertex names to Vertex objects, built from a set of Edges
    private final Map<String, Vertex> graphMap;
    public RouteGraphMap(List<DirectedEdge> directedEdges) {
    ...
    public void dijkstra(String startName) {
        if (!graphMap.containsKey(startName)) {
            throw new RouteGraphMapException("This RouteGraphMap does not contain the starting Vertex named:"+startName);
        }
    ...
    public List<Vertex> getShortestPath(String endName){
        if (!graphMap.containsKey(endName)) {
            throw new RouteGraphMapException("Graph doesn't contain end vertex : "+endName);
        }
